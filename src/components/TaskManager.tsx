      ...
      {weekDays.map((day, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 p-2 sm:p-3 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-800" style={{ maxHeight: window.innerWidth >= 640 ? '900px' : '200px' }}>
